...
public class CompleteGoodsAdapter extends RecyclerView.Adapter<CompleteGoodsAdapter.ViewHolder> {
    private List<OrderBean.OrderListBean.DetailListBean> list;
    private Context context;

    public CompleteGoodsAdapter(List<OrderBean.OrderListBean.DetailListBean> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(context).inflate(R.layout.complete_shopcar_item,viewGroup,false);
